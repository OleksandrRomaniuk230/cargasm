          ...
          <form conte class="settings__form">
            <div class="settings__photo">
              ...
              <div class="photo-add__wrapper">
                ...
                <app-add-photo @photo="form.main_photo.file = $event" />
                  ...
                  >
                    ...
                    >
                      ...
                      <app-select-time
                        ...
                        :default-time="form.dates.time.full"
                      />
                    </li>
                  </ul>
                  <app-swich
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        let { data } = await this.$api.event.eventSelect();
        this.options = data;
      } catch (e) {
        console.log(e);
      }
    ...
    dateSubmit() {
      if (this.dates.length > 1) {
        ...
        this.form.dates.date.from =this.dates;
        this.form.dates.date.to = this.dates;
      }
    },
    dateRange(e) {
    ...
    async getSetting() {
      try {
        ...
        let { data } = await this.$api.event.addEvent(formData);
      } catch (e) {
